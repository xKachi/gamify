...
// New is a helper(factory function) which creates a new Validator instance with an empty errors map.
func New() *Validator {
...
// values.
- We use  comparable because the generic function compares values for equality.
- permittedValues ...T: A variadic parameter — allows passing any number of T values (e.g., 1, 2, 3).
*/
func PermittedValue[T comparable](value T, permiitedValues ...T) bool {
	return slices.Contains(permiitedValues, value)
}
